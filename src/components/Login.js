import React, {Cmponent, Fragment} from 'react'
import PropType from 'prop-type'
import {connect, connectAdvanced} from 'react-redux'
import { Segment, Grid, Header,Image,Form ,Loader, Dimmer } from 'semantic-ui-react'
import {setAutehUser} from  '../actions/authedUser'

export class Login extends Cpmponent {
     state = {
         loading: false
     }
     handleLoading =() => {
         ...
         return (
             <Fragment>
                 <Segment.Group>
                     ...
                     <LoginGridLayout>
                         image ={<BrandImage />}
                         form = { <ConnectedLoaginForm on loading ={ this.handleLoading} />} </LoginGridLayout>
...
class LoginForm  extends Component {
    static propTypes ={
        onLoading: this.propTypes.func.isRequired
    }
    state = {
        value:''
    }
